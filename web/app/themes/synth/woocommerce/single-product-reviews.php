...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	$comment_form['comment_field'] .= '<textarea id="comment" name="comment" class="form-control" placeholder="Message *" rows="10"></textarea>' . wp_nonce_field('comment_rating', true, false);
