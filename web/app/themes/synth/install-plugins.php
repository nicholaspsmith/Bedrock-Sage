...
add_action( 'tgmpa_register', 'synth_register_plugins' );
/**
 ...
 */
function synth_register_plugins() {
    /**
     ...
     */
    $config = array(
        'domain'		=> 'synth', // Text domain - likely want to be the same as your theme.
        ...
        'strings'		=> array(
            'page_title'			=> __( 'Install Required Plugins', 'synth' ),
            'menu_title'			=> __( 'Install Plugins', 'synth' ),
            'installing'			=> __( 'Installing Plugin: %s', 'synth' ), // %1$s = plugin name
            'oops'				=> __( 'Something went wrong with the plugin API.', 'synth' ),
            ...
            'return'				=> __( 'Return to Required Plugins Installer', 'synth' ),
            'plugin_activated'			=> __( 'Plugin activated successfully.', 'synth' ),
            'complete'				=> __( 'All plugins installed and activated successfully. %s', 'synth' ), // %1$s = dashboard link
