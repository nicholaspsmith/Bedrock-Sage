...
MSPanel.ImageLayerTemplate = '{{#if view.hasImg}}<img {{bind-attr src=view.layer.img style=view.layerStyle}}>{{else}}<img src="'+ __MSP_PATH +'images/image-layer.png">{{/if}}';
