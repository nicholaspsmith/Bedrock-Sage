        ...
        if( ! apply_filters( MSWP_SLUG.'_disable_auto_update', 0 ) ) {
            ...
            $settings_fields['msp_envato_license'] = array(
                    ...
                    array(
                        ...
                        'desc'      => __( 'To find your API key, navigate to your envato account, select settings from the account dropdown, then navigate to the API Keys tab.', MSWP_TEXT_DOMAIN ) .
                                       sprintf( ' (<a href="http://support.averta.net/envato/wp-content/uploads/envato_api_key.png" target="_blank">%s</a>)  <a href="http://codecanyon.net/help/api" target="_blank">%s</a>', __( 'Screenshot', MSWP_TEXT_DOMAIN ), __( 'More info ..', MSWP_TEXT_DOMAIN ) ) ,
                        'type'      => 'password',
                        'default'   => ''
                        ),
                    array(
